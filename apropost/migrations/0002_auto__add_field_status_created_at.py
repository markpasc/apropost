...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Status.created_at'
        db.add_column('apropost_status', 'created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Status.created_at'
        db.delete_column('apropost_status', 'created_at')
