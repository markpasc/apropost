...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Author', fields ['url']
        db.create_unique('apropost_author', ['url'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Author', fields ['url']
        db.delete_unique('apropost_author', ['url'])
