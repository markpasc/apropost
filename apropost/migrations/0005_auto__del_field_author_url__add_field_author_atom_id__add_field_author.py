...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Moving 'Author.url' to 'Author.atom_id'
        db.rename_column('apropost_author', 'url', 'atom_id')

        # Adding field 'Author.homepage_url'
        db.add_column('apropost_author', 'homepage_url', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Moving 'Author.atom_id' to 'Author.url'
        db.rename_column('apropost_author', 'atom_id', 'url')

        # Deleting field 'Author.homepage_url'
        db.delete_column('apropost_author', 'homepage_url')
