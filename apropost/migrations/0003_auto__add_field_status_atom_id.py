...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Status.atom_id'
        db.add_column('apropost_status', 'atom_id', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Status.atom_id'
        db.delete_column('apropost_status', 'atom_id')
